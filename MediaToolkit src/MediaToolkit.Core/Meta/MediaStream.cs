...
namespace MediaToolkit.Core.Meta
{
    ...
    public class MediaStream
    {
        ...
        [JsonProperty("nb_frames")] public string? NbFrames { get; set; }

        [JsonProperty("disposition")] public Disposition? Disposition { get; set; }
        ...
        [JsonProperty("max_bit_rate")] public string? MaxBitRate { get; set; }
